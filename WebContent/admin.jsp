	...
	<html>
		...
		<body>
			...
			<input type="button" value="Reset Leaderboard" id="btn btn-primary" onclick="window.location.href='Reset.html'" style=" WIDTH:100%;height:50px; background-color: #292323;border: none;color: white; padding: 15px 25px;text-align: center;font-size: 16px; cursor: pointer; border-radius:25px;margin-bottom: 5px;">
